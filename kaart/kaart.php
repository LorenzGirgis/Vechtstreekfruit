...
<form action="" method="post">
    <input type="text" name="rasnaam" placeholder="Rasnaam">
    <input type="text" name="soort" placeholder="Soort">
    <input type="number" name="aantal" placeholder="Aantal">
    <input type="text" name="tijdvak" placeholder="Tijdvak">
    <input type="number" name="jaarcheck" placeholder="Jaarcheck">
